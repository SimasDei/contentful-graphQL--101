        ...
        <div className="lg:flex items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-400 lg:max-w-md mt-4">
              ...
              <a className="text-indigo-300 font-bold" href="#!">
                @BakaTeam
              </a>{' '}
              , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in sed non alias, fugiat, commodi nemo
              ut fugit corrupti dolorem sequi ex veniam consequuntur id, maiores beatae ipsa omnis aliquam?
            </p>
